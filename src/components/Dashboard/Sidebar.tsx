...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={`
        fixed md:static top-16 left-0 h-[calc(100dvh-4rem)] z-30
        flex flex-col w-60 bg-[#1c1f2e] border-r border-[#252836] text-[#eef0f6]
        py-6 overflow-hidden transition-transform duration-200
        md:translate-x-0
